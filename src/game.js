...
class Game {
  constructor() {
    ...
    this.gp = new GP(this);
    this.slayerCoins = new SlayerCoins(this);
    this.raidCoins = new RaidCoins(this);
    this.readNewsIDs = [];
    ...
    if (cloudManager.hasFullVersionEntitlement) {
      ...
      this.combatPassives.registerObject(
        new ControlledAffliction(fullNamespace, this)
      );
    }
    ...
    this.itemEffectAttack = new ItemEffectAttack(demoNamespace, this);
    ...
    this.actions.registerObject(this.township);
  ...
  registerDataPackage(dataPackage) {
    ...
    const namespace = this.registeredNamespaces.getNamespace(
      dataPackage.namespace
    );
    ...
    if (dataPackage.data !== undefined) {
      if (dataPackage.data.stackingEffects !== undefined)
        this.registerStackingEffectData(
          namespace,
          dataPackage.data.stackingEffects
        );
      if (dataPackage.data.combatPassives !== undefined)
        this.registerCombatPassiveData(
          namespace,
          dataPackage.data.combatPassives
        );
      if (dataPackage.data.attacks !== undefined)
        this.registerAttackData(namespace, dataPackage.data.attacks);
      if (dataPackage.data.pages !== undefined)
        this.registerPages(namespace, dataPackage.data.pages);
      if (dataPackage.data.pets !== undefined)
        this.registerPets(namespace, dataPackage.data.pets);
      if (dataPackage.data.attackStyles !== undefined)
        this.registerAttackStyles(namespace, dataPackage.data.attackStyles);
      if (dataPackage.data.prayers !== undefined)
        this.registerPrayerData(namespace, dataPackage.data.prayers);
      if (dataPackage.data.items !== undefined)
        this.registerItemData(namespace, dataPackage.data.items);
      if (dataPackage.data.bankSortOrder !== undefined)
        this.bank.registerSortOrder(dataPackage.data.bankSortOrder);
      if (dataPackage.data.itemUpgrades !== undefined)
        this.bank.registerItemUpgrades(dataPackage.data.itemUpgrades);
      if (dataPackage.data.itemSynergies !== undefined)
        this.registerItemSynergies(dataPackage.data.itemSynergies);
      if (dataPackage.data.randomGems !== undefined)
        this.randomGemTable.registerDrops(this, dataPackage.data.randomGems);
      if (dataPackage.data.randomSuperiorGems !== undefined)
        this.randomSuperiorGemTable.registerDrops(
          this,
          dataPackage.data.randomSuperiorGems
        );
      if (dataPackage.data.golbinRaid !== undefined)
        this.golbinRaid.registerData(dataPackage.data.golbinRaid);
      if (dataPackage.data.gamemodes !== undefined)
        this.registerGamemodes(namespace, dataPackage.data.gamemodes);
      if (dataPackage.data.standardSpells !== undefined)
        this.registerStandardSpellData(
          namespace,
          dataPackage.data.standardSpells
        );
      if (dataPackage.data.auroraSpells !== undefined)
        this.registerAuroraSpellData(namespace, dataPackage.data.auroraSpells);
      if (dataPackage.data.curseSpells !== undefined)
        this.registerCurseSpellData(namespace, dataPackage.data.curseSpells);
      if (dataPackage.data.itemEffects !== undefined)
        this.itemEffectAttack.registerItemEffects(
          namespace,
          dataPackage.data.itemEffects,
          this
        );
      if (dataPackage.data.monsters !== undefined)
        this.registerMonsterData(namespace, dataPackage.data.monsters);
      if (dataPackage.data.itmMonsters !== undefined)
        this.registerRandomMonsters(
          dataPackage.data.itmMonsters,
          this.combat.itmMonsters
        );
      if (dataPackage.data.spiderLairMonsters !== undefined)
        this.registerRandomMonsters(
          dataPackage.data.spiderLairMonsters,
          this.combat.spiderLairMonsters
        );
      if (dataPackage.data.combatAreas !== undefined)
        this.registerCombatAreaData(namespace, dataPackage.data.combatAreas);
      if (dataPackage.data.slayerAreas !== undefined)
        this.registerSlayerAreaData(namespace, dataPackage.data.slayerAreas);
      if (dataPackage.data.combatEvents !== undefined)
        this.registerCombatEventData(namespace, dataPackage.data.combatEvents);
      if (dataPackage.data.dungeons !== undefined)
        this.registerDungeonData(namespace, dataPackage.data.dungeons);
      if (dataPackage.data.combatAreaDisplayOrder !== undefined)
        this.combatAreaDisplayOrder.registerData(
          dataPackage.data.combatAreaDisplayOrder
        );
      if (dataPackage.data.slayerAreaDisplayOrder !== undefined)
        this.slayerAreaDisplayOrder.registerData(
          dataPackage.data.slayerAreaDisplayOrder
        );
      if (dataPackage.data.dungeonDisplayOrder !== undefined)
        this.dungeonDisplayOrder.registerData(
          dataPackage.data.dungeonDisplayOrder
        );
      if (dataPackage.data.ancientSpells !== undefined)
        this.registerAncientSpellData(
          namespace,
          dataPackage.data.ancientSpells
        );
      if (dataPackage.data.archaicSpells !== undefined)
        this.registerArchaicSpellData(
          namespace,
          dataPackage.data.archaicSpells
        );
      if (dataPackage.data.shopCategories !== undefined)
        this.registerShopCategories(namespace, dataPackage.data.shopCategories);
      if (dataPackage.data.shopCategoryOrder !== undefined)
        this.shop.categoryDisplayOrder.registerData(
          dataPackage.data.shopCategoryOrder
        );
      if (dataPackage.data.shopPurchases !== undefined)
        this.registerShopPurchases(namespace, dataPackage.data.shopPurchases);
      if (dataPackage.data.shopDisplayOrder !== undefined)
        this.shop.purchaseDisplayOrder.registerData(
          dataPackage.data.shopDisplayOrder
        );
      if (dataPackage.data.shopUpgradeChains !== undefined)
        this.registerShopUpgradeChains(
          namespace,
          dataPackage.data.shopUpgradeChains
        );
      if (dataPackage.data.skillData !== undefined) {
        dataPackage.data.skillData.forEach((skillsData) => {
      ...
      if (
        !namespace.isModded &&
        dataPackage.data.steamAchievements !== undefined
      )
        this.registerSteamAchievements(dataPackage.data.steamAchievements);
      if (dataPackage.data.lore !== undefined)
        this.lore.registerLore(namespace, dataPackage.data.lore);
      if (!namespace.isModded) {
        if (dataPackage.data.tutorialStages !== undefined)
          this.tutorial.registerStages(
            namespace,
            dataPackage.data.tutorialStages
          );
        if (dataPackage.data.tutorialStageOrder !== undefined)
          this.tutorial.registerStageOrder(dataPackage.data.tutorialStageOrder);
      }
      this.softDataRegQueue.forEach(([data, object]) =>
    ...
    if (dataPackage.namespaceChange !== undefined) {
      if (dataPackage.namespaceChange.items !== undefined) {
        this.items.registerNamespaceChange(
          namespace,
          dataPackage.namespaceChange.items
        );
      }
    }
  }
  queueForSoftDependencyReg(data, object) {
    this.softDataRegQueue.push([data, object]);
  }
  postDataRegistration() {
    ...
    this.skills.forEach((skill) => skill.postDataRegistration());
  ...
  registerAttackStyles(namespace, data) {
    data.forEach((data) =>
      this.attackStyles.registerObject(new AttackStyle(namespace, data, this))
    );
  }
  registerItemData(namespace, data) {
    data.forEach((itemData) => {
      switch (itemData.itemType) {
        case "Item":
          this.items.registerObject(new Item(namespace, itemData));
          break;
        case "Equipment":
          this.items.registerObject(
            new EquipmentItem(namespace, itemData, this)
          );
          break;
        case "Weapon":
          ...
          break;
        case "Food":
          this.items.registerObject(new FoodItem(namespace, itemData));
          break;
        case "Bone":
          this.items.registerObject(new BoneItem(namespace, itemData));
          break;
        case "Potion":
          this.items.registerObject(new PotionItem(namespace, itemData, this));
          break;
        case "Readable":
          this.items.registerObject(new ReadableItem(namespace, itemData));
          break;
        case "Openable":
          this.items.registerObject(
            new OpenableItem(namespace, itemData, this)
          );
          break;
        case "Token":
          ...
          break;
        case "Compost":
          this.items.registerObject(new CompostItem(namespace, itemData));
          break;
      }
    });
  }
  registerAttackData(namespace, data) {
    data.forEach((attackData) => {
      this.specialAttacks.registerObject(
        new SpecialAttack(namespace, attackData, this)
      );
    });
  }
  registerStackingEffectData(namespace, data) {
    data.forEach((effectData) => {
      this.stackingEffects.registerObject(
        new StackingEffect(namespace, effectData)
      );
    });
  }
  registerCombatPassiveData(namespace, data) {
    data.forEach((passiveData) => {
      this.combatPassives.registerObject(
        new CombatPassive(namespace, passiveData)
      );
    });
  }
  ...
  registerRandomMonsters(monsterIDs, monsterArray) {
    monsterIDs.forEach((monsterID) => {
      ...
      if (monster === undefined)
        throw new Error(
          `Error registering random dungeon monsters, monster with id: ${monsterID} is not registered.`
        );
  ...
  registerSlayerAreaData(namespace, data) {
    data.forEach((data) => {
      this.slayerAreas.registerObject(new SlayerArea(namespace, data, this));
    });
  }
  registerDungeonData(namespace, data) {
    data.forEach((data) => {
      this.dungeons.registerObject(new Dungeon(namespace, data, this));
    });
  }
  ...
  registerPrayerData(namespace, data) {
    data.forEach((data) =>
      this.prayers.registerObject(new ActivePrayer(namespace, data, this))
    );
  }
  registerStandardSpellData(namespace, data) {
    data.forEach((data) =>
      this.standardSpells.registerObject(
        new StandardSpell(namespace, data, this)
      )
    );
  }
  registerCurseSpellData(namespace, data) {
    data.forEach((data) =>
      this.curseSpells.registerObject(new CurseSpell(namespace, data, this))
    );
  }
  registerAuroraSpellData(namespace, data) {
    data.forEach((data) =>
      this.auroraSpells.registerObject(new AuroraSpell(namespace, data, this))
    );
  }
  registerAncientSpellData(namespace, data) {
    data.forEach((data) =>
      this.ancientSpells.registerObject(new AncientSpell(namespace, data, this))
    );
  }
  registerArchaicSpellData(namespace, data) {
    data.forEach((data) =>
      this.archaicSpells.registerObject(new ArchaicSpell(namespace, data, this))
    );
  }
  registerPets(namespace, data) {
    data.forEach((data) =>
      this.pets.registerObject(new Pet(namespace, data, this))
    );
  }
  registerShopCategories(namespace, data) {
    data.forEach((data) =>
      this.shop.categories.registerObject(
        new ShopCategory(namespace, data, this)
      )
    );
  }
  registerShopPurchases(namespace, data) {
    data.forEach((data) =>
      this.shop.purchases.registerObject(
        new ShopPurchase(namespace, data, this)
      )
    );
  }
  registerShopUpgradeChains(namespace, data) {
    data.forEach((data) =>
      this.shop.upgradeChains.registerObject(
        new ShopUpgradeChain(namespace, data, this)
      )
    );
  }
  ...
  registerGamemodes(namespace, data) {
    data.forEach((gamemodeData) =>
      this.gamemodes.registerObject(new Gamemode(namespace, gamemodeData, this))
    );
  }
  registerSteamAchievements(data) {
    data.forEach((achieveData) =>
      this.steamAchievements.set(
        achieveData.id,
        new SteamAchievement(achieveData, this)
      )
    );
  }
  registerPages(namespace, data) {
    data.forEach((pageData) =>
      this.pages.registerObject(new Page(namespace, pageData, this))
    );
  }
  registerSkill(namespace, constructor) {
    ...
    if (
      skillInstance.modifiers !== undefined ||
      skillInstance.enemyModifiers !== undefined ||
      skillInstance.conditionalModifiers !== undefined ||
      skillInstance.equipmentStats !== undefined
    ) {
  ...
  applyDataModifications(modificationData) {
    ...
    (_a = modificationData.shopUpgradeChains) === null || _a === void 0
      ? void 0
      : _a.forEach((modData) => {
          const upgradeChain = this.shop.upgradeChains.getObjectByID(
            modData.id
          );
          if (upgradeChain === undefined)
            throw new UnregisteredDataModError(
              ShopUpgradeChain.name,
              modData.id
            );
  ...
  getPlayerModifiersFromData(data) {
    const modifierObject = {};
    Object.entries(data).forEach((entry) => {
      if (isSkillEntry(entry)) {
        modifierObject[entry[0]] = entry[1].map(({ skillID, value }) => {
          const skill = this.skills.getObjectByID(skillID);
          if (skill === undefined)
            throw new Error(
              `Error creating modifier object from data. Skill with id: ${skillID} is not registered.`
            );
          return { skill, value };
        });
      } else {
        modifierObject[entry[0]] = entry[1];
      }
    });
  ...
  getRequirementFromData(data) {
    switch (data.type) {
      case "DungeonCompletion":
        return this.getDungeonRequirement(data);
      case "SkillLevel":
        return this.getLevelRequirement(data);
      case "ShopPurchase":
        return this.getShopPurchaseRequirement(data);
      case "SlayerItem":
        return this.getSlayerItemRequirement(data);
      case "ItemFound":
        return this.getItemFoundRequirement(data);
      case "MonsterKilled":
        return this.getMonsterKilledRequirement(data);
      case "TownshipBuilding":
        return this.getTownshipBuildingRequirement(data);
      case "AllSkillLevels":
        return this.getAllSkillLevelRequirement(data);
      case "SlayerTask":
        return this.getSlayerTaskRequirement(data);
      case "Completion":
        return this.getCompletionRequirement(data);
      case "TownshipTask":
        return data;
  ...
  getDungeonRequirement(data) {
    const dungeon = this.dungeons.getObjectByID(data.dungeonID);
    if (dungeon === undefined)
      throw new Error(
        `Error getting dungeon requirement. Dungeon with id: ${data.dungeonID} is not registered.`
      );
    return { type: data.type, dungeon, count: data.count };
  }
  getLevelRequirement(data) {
    const skill = this.skills.getObjectByID(data.skillID);
    if (skill === undefined)
      throw new Error(
        `Error getting level requirement. Skill with id: ${data.skillID} is not registered.`
      );
    return { type: data.type, skill, level: data.level };
  }
  getSlayerItemRequirement(data) {
    const item = this.items.equipment.getObjectByID(data.itemID);
    if (item === undefined)
      throw new Error(
        `Error getting slayer item requirement. Item with id: ${data.itemID} is not registered.`
      );
    return { type: data.type, item };
  }
  getItemFoundRequirement(data) {
    const item = this.items.getObjectByID(data.itemID);
    if (item === undefined)
      throw new Error(
        `Error getting item found requirement. Item with id: ${data.itemID} is not registered.`
      );
    return { type: data.type, item };
  }
  getMonsterKilledRequirement(data) {
    const monster = this.monsters.getObjectByID(data.monsterID);
    if (monster === undefined)
      throw new Error(
        `Error getting MonsterKilledRequirement. Monster with id: ${data.monsterID} is not registered.`
      );
    return { type: data.type, monster, count: data.count };
  }
  getShopPurchaseRequirement(data) {
    const purchase = this.shop.purchases.getObjectByID(data.purchaseID);
    if (purchase === undefined)
      throw new Error(
        `Error getting shop purchase requirement. Shop purchase with id: ${data.purchaseID} is not registered.`
      );
    return { type: data.type, purchase, count: data.count };
  }
  getTownshipBuildingRequirement(data) {
    const building = this.township.buildings.getObjectByID(data.buildingID);
    if (building === undefined)
      throw new Error(
        `Error getting township building requirement. Building with id: ${data.buildingID} is not registered.`
      );
    return { type: data.type, building, count: data.count };
  }
  getAllSkillLevelRequirement(data) {
    const requirement = { type: "AllSkillLevels", level: data.level };
    if (data.exceptions !== undefined) {
      requirement.exceptions = new Set(
        data.exceptions.map((id) => {
          const skill = this.skills.getObjectByID(id);
          if (skill === undefined)
            throw new Error(
              `Error getting all skill level requirement. Skill with id ${id} is not registered`
            );
          return skill;
        })
      );
  ...
  getSlayerTaskRequirement(data) {
    return {
      type: "SlayerTask",
      tier: SlayerTierID[data.tier],
      count: data.count,
    };
  }
  getCompletionRequirement(data) {
    const namespace = this.registeredNamespaces.getNamespace(data.namespace);
    if (namespace === undefined)
      throw new Error(
        `Error getting completion requirement. Namespace ${data.namespace} is not registered`
      );
    return { type: "Completion", percent: data.percent, namespace };
  }
  getDummyData(fullID) {
  ...
  pauseActiveSkill(fromBlur = false) {
    ...
    if (fromBlur) this.stopMainLoop();
  }
  unpauseActiveSkill(fromFocus = false) {
    return __awaiter(this, void 0, void 0, function* () {
      if (!this._isPaused || this.isUnpausing) return;
      ...
      if (this.pausedAction !== undefined) {
        ...
        yield this.processOffline();
        if (wasGolbinRaid) {
          switch (this.activeAction) {
            case this.thieving:
              this.thieving.onLoad();
              break;
            case this.firemaking:
      ...
      if (fromFocus) this.startMainLoop();
      this.isUnpausing = false;
    });
  }
  idleChecker(action) {
  ...
  onLoad() {
    ...
    if (this.golbinRaid.raidRunning && this.activeAction !== this.golbinRaid) {
      ...
      if (
        ...
        !(currentActive instanceof BaseManager) &&
    ...
    if (
      this.thieving.isActive &&
      this.activeAction !== this.thieving &&
      this.pausedAction !== this.thieving
    ) {
  ...
  processTime() {
    ...
    let ticksToRun = Math.floor(
      (currentTickTime - this.previousTickTime) / TICK_INTERVAL
    );
  ...
  runTicks(ticksToRun) {
    ...
    if (ticksToRun > 72000) {
      ...
      console.log(
        `Took ${processingTime / 1000}s to process ${ticksToRun} ticks. ${
          processingTime / ticksToRun
        }ms per tick.`
      );
    }
  }
  tick() {
    ...
    if (this.isGolbinRaid) {
      ...
      (_a = this.activeAction) === null || _a === void 0
        ? void 0
        : _a.activeTick();
  ...
  queueRequirementRenders() {
    this.combat.rendersRequired.areaRequirements = true;
    this.combat.rendersRequired.spellBook = true;
  ...
  renderGameTitle() {
    if (this.renderQueue.title) {
      ...
      if (
        ...
        title = `${getLangString("SKILL_NAME", "Hitpoints")} ${numberWithCommas(
          this.combat.player.hitpoints
        )}`;
      } else if (this.activeAction === this.golbinRaid) {
        title = `${getLangString("SKILL_NAME", "Hitpoints")} ${numberWithCommas(
          this.golbinRaid.player.hitpoints
        )}`;
      }
      $("title").text(title);
    }
  ...
  renderCombatMinibar() {
    ...
    if (
      ...
      !(
        ((_a = this.openPage) === null || _a === void 0 ? void 0 : _a.id) ===
          "melvorD:Combat" && !this.settings.showCombatMinibarCombat
      )
    ) {
      showElement(minibar);
    } else {
  ...
  loop() {
    if (!this.isGolbinRaid) this.tickTimestamp = new Date().getTime();
    try {
      this.processTime();
    } catch (e) {
      this.stopMainLoop();
...
Active Action: ${
      (_b = this.activeAction) === null || _b === void 0 ? void 0 : _b.id
    }
${errorBody}
${equipmentText}
${activeSkillLog}
${moddingLog}`;
  ...
  showBrokenGame(error, title) {
    ...
    const mods = mod.getModsFromError(error);
    if (mods.length === 0) {
      $("#ticks-broke-dev").text(
        "Maybe you should let the dev know about this error. Please copy the entire contents of this error message when reporting:"
      );
    } else {
      $("#ticks-broke-text").html(
  ...
  clearActiveAction(save = true) {
    if (!this.disableClearOffline) {
      ...
      this.activeAction = undefined;
      if (save) saveData("all");
      deleteScheduledPushNotification("offlineSkill");
    }
  }
  getOfflineTimeDiff() {
    const currentTime = Date.now();
    const originalTimeDiff = currentTime - this.tickTimestamp;
    const timeDiff = Math.min(originalTimeDiff, 86400000);
    return { timeDiff, originalTimeDiff };
  }
  processOffline() {
    if (DEBUGENABLED && this.activeAction === this.combat)
    ...
    return new Promise((resolve, reject) => {
      ...
      if (
        this.activeAction === this.combat &&
        (!this.settings.enableOfflineCombat ||
          (this.combat.selectedArea instanceof SlayerArea &&
            !this.slayer.isUnlocked))
      ) {
        this.combat.stop();
        resolve();
        return;
      ...
      const hasOfflineAction = this.activeAction !== undefined;
      loadingOfflineProgress = true;
      if (hasOfflineAction) {
        const modalID = offlineModalID;
        offlineModalID++;
        const html = `<div id="offline-modal-${modalID}" style="height:auto;"><small><div class="spinner-border spinner-border-sm text-primary mr-2" id="offline-progress-spinner" role="status"></div>${getLangString(
          "MENU_TEXT",
        ...
        addModalToQueue(welcomeBackModal.alertOptions);
      }
      setTimeout(() => {
        var _a;
        const snapShot = this.snapShotOffline();
        const { timeDiff } = this.getOfflineTimeDiff();
        let offlineMessage;
        try {
          ...
          const messageArea = getElementFromFragment(
            messageDoc,
            "broken-offline-template-message",
            "textarea"
          );
          messageArea.value = this.getErrorLog(
            e,
            "An error occured while processing ticks offline:"
          );
          const devText = getElementFromFragment(messageDoc, "dev-text", "h5");
          const modText = getElementFromFragment(messageDoc, "mod-text", "h5");
          const mods = mod.getModsFromError(e);
          if (mods.length === 0) {
            devText.textContent = `Please let the dev know of this error. Please copy the entire contents of the error message when reporting it:`;
            hideElement(modText);
          } else {
            devText.textContent = `Please report this error to the mod developer(s):`;
            showElement(modText);
            modText.innerHTML = `<strong>Error due to Mods:</strong><br>${mods
              .map(({ name, version }) => `${name}: v${version}`)
              .join("<br>")}`;
          }
        ...
        if (welcomeBackModal !== undefined) {
          const modalInDOM = document.getElementById(
            `offline-modal-${welcomeBackModal.id}`
          );
          if (modalInDOM !== null) {
            if (typeof offlineMessage === "string")
              modalInDOM.innerHTML = offlineMessage;
            else {
              modalInDOM.textContent = "";
              modalInDOM.append(offlineMessage);
            }
          } else {
            const offlineDiv = createElement("div", {
              id: `offline-modal-${welcomeBackModal.id}`,
  ...
  snapShotOffline() {
    ...
    this.monsters.forEach((monster) =>
      monsterKills.set(monster, this.stats.monsterKillCount(monster))
    );
    ...
    const snapshot = {
      gp: this.gp.amount,
      slayercoins: this.slayerCoins.amount,
  ...
  createOfflineModal(oldSnapshot, timeDiff) {
    ...
    timeText += `<br><small class="text-danger">${getLangString(
      "MENU_TEXT",
      "MAX_OFFLINE_TIME"
    )}</small>`;
    ...
    newSnapshot.experience.forEach((xp, skill) => {
      var _a;
      const xpDiff = Math.floor(
        xp -
          ((_a = oldSnapshot.experience.get(skill)) !== null && _a !== void 0
            ? _a
            : 0)
      );
      if (xpDiff > 0) xpGain.set(skill, xpDiff);
    });
    newSnapshot.levels.forEach((level, skill) => {
      var _a;
      const levelDiff =
        level -
        ((_a = oldSnapshot.levels.get(skill)) !== null && _a !== void 0
          ? _a
          : 0);
    ...
    newSnapshot.monsterKills.forEach((kills, monster) => {
      var _a;
      const newKills =
        kills -
        ((_a = oldSnapshot.monsterKills.get(monster)) !== null && _a !== void 0
          ? _a
          : 0);
      if (newKills > 0) monstersKilled.set(monster, newKills);
    });
    ...
    newSnapshot.dungeonCompletion.forEach((completions, dungeon) => {
      ...
      const newComps =
        completions -
        ((_a = oldSnapshot.dungeonCompletion.get(dungeon)) !== null &&
        _a !== void 0
          ? _a
          : 0);
      if (newComps > 0) dungeonsCompleted.set(dungeon, newComps);
    });
    const tasksCompleted = newSnapshot.taskCompletions.map(
      (newCount, tier) => newCount - oldSnapshot.taskCompletions[tier]
    );
    const marksFound = new Map();
    newSnapshot.summoningMarks.forEach((newCount, mark) => {
      var _a;
      const oldCount =
        (_a = oldSnapshot.summoningMarks.get(mark)) !== null && _a !== void 0
          ? _a
          : 0;
    ...
    oldSnapshot.itemCharges.forEach((quantity, item) => {
      var _a;
      quantity -=
        (_a = newSnapshot.itemCharges.get(item)) !== null && _a !== void 0
          ? _a
          : 0;
    ...
    oldSnapshot.food.forEach(({ item, quantity }, i) => {
      ...
      if (qtyDiff > 0) foodEaten.push({ item, quantity: qtyDiff });
        ...
        itemsGained.set(
          item,
          ((_a = itemsGained.get(item)) !== null && _a !== void 0 ? _a : 0) -
            qtyDiff
        );
      }
    });
    ...
    const orichaNode = getNodeDiff(
      oldSnapshot.orichaNode,
      newSnapshot.orichaNode
    );
    const ceruleanNode = getNodeDiff(
      oldSnapshot.ceruleanNode,
      newSnapshot.ceruleanNode
    );
    ...
    xpGain.forEach((xpGain, skill) => {
      outputHeaders.push(
        templateString(getLangString("MISC_STRING", "6"), {
    ...
    levelGain.forEach((levelGain, skill) => {
      ...
      const templateData = {
        ...
        newLevel: `${
          (_b = newSnapshot.levels.get(skill)) !== null && _b !== void 0
            ? _b
            : 1
        }`,
      };
      outputHeaders.push(
        templateLangString(
          "MENU_TEXT",
          levelGain === 1 ? "LEVELED_UP_SKILL_ONCE" : "LEVELED_UP_SKILL_TIMES",
          templateData
        )
      );
    });
    monstersKilled.forEach((killDiff, monster) => {
      if (killDiff > 0) {
        outputHeaders.push(
          templateLangString("MENU_TEXT", "YOU_KILLED_MONSTER", {
            count: `${killDiff}`,
    ...
    tasksCompleted.forEach((taskCount, tier) => {
      if (taskCount > 0) {
        outputHeaders.push(
          templateLangString("MENU_TEXT", `COMPLETED_SLAYER_TASK_${tier}`, {
            count: `${taskCount}`,
          })
        );
      }
    ...
    marksFound.forEach((markCount, mark) => {
      if (markCount > 0) {
        outputHeaders.push(
          templateLangString("MENU_TEXT", "YOU_FOUND_MARK", {
    ...
    itemsGained.forEach((qty, item) => {
      outputHeaders.push(
        templateLangString("MENU_TEXT", "YOU_GAINED_ITEM", {
          count: posSpan(numberWithCommas(qty)),
          itemImage: image(item.media),
          itemName: item.name,
        })
      );
      itemGPValue += qty * item.sellsFor;
    });
    stockPileItemsGained.forEach(({ quantity, item }) => {
      ...
      itemGPValue += quantity * item.sellsFor;
    });
    if (DEBUGENABLED)
      outputHeaders.push(
        `Total Item Value: ${numberWithCommas(itemGPValue)} GP`
      );
    newSnapshot.loot.forEach((qty, item) => {
      outputHeaders.push(
        templateLangString("MENU_TEXT", "YOU_HAVE_ITEM_LOOT", {
          count: posSpan(numberWithCommas(qty)),
          itemImage: image(item.media),
          itemName: item.name,
        })
    ...
    lostLoot.forEach((qty, item) => {
      outputHeaders.push(
        templateLangString("MENU_TEXT", "LOST_ITEM_LOOT", {
          count: posSpan(numberWithCommas(qty)),
          itemImage: image(item.media),
          itemName: item.name,
        })
    ...
    lostItems.forEach((qty, item) => {
      outputHeaders.push(
        templateLangString("MENU_TEXT", "LOST_ITEM_BANK", {
          count: posSpan(numberWithCommas(qty)),
          itemImage: image(item.media),
          itemName: item.name,
        })
    ...
    if (gpDiff !== 0) {
      outputHeaders.push(
        currencyDiff(gpDiff, "GP", `${CDNDIR}assets/media/main/coins.svg`)
      );
    }
    if (scDiff !== 0) {
      outputHeaders.push(
        currencyDiff(
          scDiff,
          "SC",
          `${CDNDIR}assets/media/main/slayer_coins.svg`
        )
      );
    }
    if (ppDiff !== 0) {
      outputHeaders.push(
        currencyDiff(
          ppDiff,
          "PP",
          `${CDNDIR}assets/media/skills/prayer/prayer.svg`
        )
      );
    }
    itemsUsed.forEach((qty, item) => {
      outputHeaders.push(
        templateLangString("MENU_TEXT", "ITEM_USAGE", {
    ...
    oldSnapshot.equipment.forEach((oldQuantity, slot) => {
      ...
      if (
        ...
        oldQuantity.item === this.emptyEquipmentItem
      )
        return;
      const quantityUsed =
        newQuantity.item === this.emptyEquipmentItem
    ...
    foodEaten.forEach(({ quantity, item }) => {
      outputHeaders.push(
        templateLangString("MENU_TEXT", "FOOD_EATEN", {
    ...
    itemChargesUsed.forEach(({ item, quantity }) => {
      if (quantity > 0)
        outputHeaders.push(
          templateLangString("MENU_TEXT", "GLOVE_CHARGE_USAGE", {
            count: negSpan(numberWithCommas(quantity)),
            itemImage: image(item.media),
            itemName: item.name,
          })
    ...
    addMiningNodeHeader(
      ...
      "assets/media/skills/astrology/meteorite.svg"
    );
    addMiningNodeHeader(
      onyxNode,
      "ONYX_FOUND_ONE",
      "ONYX_FOUND_MANY",
      "assets/media/bank/onyx.png"
    );
    addMiningNodeHeader(
      orichaNode,
      "ORICHA_FOUND_ONE",
      "ORICHA_FOUND_MANY",
      "assets/media/bank/oricha.png"
    );
    addMiningNodeHeader(
      ceruleanNode,
      "CERULEAN_FOUND_ONE",
      "CERULEAN_FOUND_MANY",
      "assets/media/bank/cerulean.png"
    );
    let html = `<h5 class='font-w400'>${templateString(
      getLangString("MISC_STRING", "4"),
    ...
    html += `<h5 class='font-w600 mb-1'>${outputHeaders.join(
      `</h5><h5 class='font-w600 mb-1'>`
    )}</h5>`;
    return html;
  }
  ...
  generateSaveString() {
    ...
    this.encode(writer);
    return writer.getSaveString(this.getSaveHeader());
  }
        ...
        if (e instanceof Error && e.message === "String is not save.") {
          try {
            ...
            if (gamemodeID === undefined)
              throw new Error(
                `No Gamemode maps to: ${saveGame.currentGamemode}`
              );
            let currentGamemode = this.gamemodes.getObjectByID(gamemodeID);
            if (currentGamemode === undefined) {
              currentGamemode = new DummyGamemode(
                this.getDummyData(gamemodeID),
                this
              );
            }
            let offlineAction = undefined;
            if (saveGame.offline.skill !== null) {
              offlineAction = this.activeActions.getObjectByID(
                idMap.offlineSkillToAction[saveGame.offline.skill]
              );
            }
            const header = {
              ...
              offlineAction,
              tickTimestamp:
                (_a = saveGame.offline.timestamp) !== null && _a !== void 0
                  ? _a
                  : 0,
  ...
  getSaveHeader() {
    ...
    return {
      ...
      totalSkillLevel:
        this.completion.skillProgress.currentCount.getCompValue("melvorTrue"),
      gp: this.gp.amount,
      offlineAction,
  ...
  deserialize(reader, version, idMap) {
    ...
    if (version >= 12) {
      this.golbinRaid.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
      this._isPaused = reader.getBool();
      this.woodcutting.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
      this.herblore.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
    ...
    if (version >= 13) {
      this.smithing.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
      this.altMagic.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
    ...
    if (version >= 16) {
      this.runecrafting.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
      this.crafting.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
      this.fletching.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
      this.summoning.deserialize(
        reader.getVariableLengthChunk(),
        version,
        idMap
      );
  ...
  getSkillUnlockCost() {
    ...
    costIndex = Math.min(
      costIndex,
      this.currentGamemode.skillUnlockCost.length - 1
    );
    return this.currentGamemode.skillUnlockCost[costIndex];
  }
  checkSkillRequirement(requirement, notifyOnFailure = false) {
    if (!requirement.skill.isUnlocked) {
      if (notifyOnFailure)
        lockedSkillAlert(requirement.skill, "SKILL_UNLOCK_DO_THAT");
      return false;
    } else {
      const met = requirement.skill.level >= requirement.level;
      if (!met && notifyOnFailure)
        notifyPlayer(
          requirement.skill,
          templateLangString("TOASTS", "SKILL_LEVEL_REQUIRED", {
  ...
  checkAllSkillLevelRequirement(requirement, notifyOnFailure = false) {
    const met = this.skills.every(
      (skill) =>
    ...
    if (!met && notifyOnFailure) {
      imageNotify(
        cdnMedia("assets/media/main/milestones_header.svg"),
        templateLangString("TOASTS", "ALL_SKILL_LEVEL_REQUIRED", {
          level: `${requirement.level}`,
        }),
        "danger"
      );
  ...
  checkDungeonRequirement(requirement, notifyOnFailure = false) {
    const met =
      this.combat.getDungeonCompleteCount(requirement.dungeon) >=
      requirement.count;
    let countText;
    if (requirement.count > 1) {
      countText = `${requirement.count} times`;
    } else {
      countText = "once";
    }
    if (!met && notifyOnFailure) {
  ...
  checkCompletionRequirement(requirement, notifyOnFailure = false) {
    const met =
      this.completion.totalProgressMap.get(requirement.namespace.name) >=
      requirement.percent;
    if (!met && notifyOnFailure) {
      const langID = requirement.namespace.isModded
        ? "COMPLETION_PERCENT_REQUIRED_MOD"
        : `COMPLETION_PERCENT_REQUIRED_${requirement.namespace.name}`;
      notifyPlayer(
        this.attack,
        templateLangString("TOASTS", langID, {
  ...
  checkSlayerItemRequirement(
    ...
    const met =
      this.modifiers.bypassAllSlayerItems > 0 ||
      (slayerLevelReq < 100 && this.modifiers.bypassSlayerItems > 0) ||
      this.combat.player.equipment.checkForItem(requirement.item);
    if (!met && notifyOnFailure)
      notifyPlayer(
        this.attack,
        templateLangString("TOASTS", "ITEM_EQUIPPED_REQUIRED", {
  ...
  checkShopPurchaseRequirement(requirement, notifyOnFailure = false) {
    const met =
      this.shop.getPurchaseCount(requirement.purchase) >= requirement.count;
    if (!met && notifyOnFailure)
      notifyPlayer(
        this.attack,
        templateLangString("TOASTS", "SHOP_PURCHASE_REQUIRED", {
          purchaseName: requirement.purchase.name,
        }),
        "danger"
      );
    return met;
  }
  checkSlayerTaskRequirement(requirement, notifyOnFailure = false) {
    const met =
      this.combat.slayerTask.getTaskCompletionsForTierAndAbove(
        requirement.tier
      ) >= requirement.count;
    if (!met && notifyOnFailure) {
      imageNotify(
        ...
        templateLangString(
          "TOASTS",
          `SLAYER_TASK_REQUIRED_${
            SlayerTask.data[requirement.tier].engDisplay
          }`,
          { count: `${requirement.count}` }
        ),
        "danger"
  ...
  checkItemFoundRequirement(requirement, notifyOnFailure = false) {
    const met = this.stats.itemFindCount(requirement.item) > 0;
    if (!met && notifyOnFailure) {
      imageNotify(
        requirement.item.media,
        templateLangString("TOASTS", "ITEM_FOUND_REQUIRED", {
          itemName: requirement.item.name,
        }),
        "danger"
      );
  ...
  checkMonsterKilledRequirement(requirement, notifyOnFailure = false) {
    const met =
      this.stats.monsterKillCount(requirement.monster) >= requirement.count;
    if (!met && notifyOnFailure) {
      imageNotify(
        requirement.monster.media,
        templateLangString(
          "TOASTS",
          requirement.count > 1
  ...
  checkTownshipTaskRequirement(requirement, notifyOnFailure = false) {
    const met = this.township.tasks.tasksCompleted >= requirement.count;
    const tasksLeft = 0;
    if (!met && notifyOnFailure) {
      imageNotify(
        this.township.media,
        `You must complete ${tasksLeft} more Township Getting Started tasks to do that!`,
        "danger"
      );
    }
    return met;
  }
  checkTownshipTutorialTaskRequirement(requirement, notifyOnFailure = false) {
    const met = this.township.tasks.tutorialTasksCompleted >= requirement.count;
    const tasksLeft = 0;
    if (!met && notifyOnFailure) {
      imageNotify(
        this.township.media,
        `You must complete ${tasksLeft} more Township tasks to do that!`,
        "danger"
      );
    }
    return met;
  }
  checkTownshipBuildingRequirement(requirement, notifyOnFailure = false) {
    const buildCount = this.township.countNumberOfBuildings(
      requirement.building
    );
    const met = buildCount >= requirement.count;
    if (!met && notifyOnFailure) {
      const buildingsLeft = requirement.count - buildCount;
      imageNotify(
        requirement.building.media,
        `You must build ${buildingsLeft} more ${requirement.building.name} to do that!`,
        "danger"
      );
    }
    return met;
  ...
  checkRequirement(requirement, notifyOnFailure = false, slayerLevelReq = 0) {
    switch (requirement.type) {
      case "SkillLevel":
        return this.checkSkillRequirement(requirement, notifyOnFailure);
      case "AllSkillLevels":
        return this.checkAllSkillLevelRequirement(requirement, notifyOnFailure);
      case "DungeonCompletion":
        return this.checkDungeonRequirement(requirement, notifyOnFailure);
      case "Completion":
        return this.checkCompletionRequirement(requirement, notifyOnFailure);
      case "SlayerItem":
        return this.checkSlayerItemRequirement(
          requirement,
          notifyOnFailure,
          slayerLevelReq
        );
      case "ShopPurchase":
        return this.checkShopPurchaseRequirement(requirement, notifyOnFailure);
      case "SlayerTask":
        return this.checkSlayerTaskRequirement(requirement, notifyOnFailure);
      case "ItemFound":
        return this.checkItemFoundRequirement(requirement, notifyOnFailure);
      case "MonsterKilled":
        return this.checkMonsterKilledRequirement(requirement, notifyOnFailure);
      case "TownshipTask":
        return this.checkTownshipTaskRequirement(requirement, notifyOnFailure);
      case "TownshipTutorialTask":
        return this.checkTownshipTutorialTaskRequirement(
          requirement,
          notifyOnFailure
        );
      case "TownshipBuilding":
        return this.checkTownshipBuildingRequirement(
          requirement,
          notifyOnFailure
        );
    }
  ...
  checkRequirements(requirements, notifyOnFailure = false, slayerLevelReq = 0) {
    return requirements.every((requirement) =>
      this.checkRequirement(requirement, notifyOnFailure, slayerLevelReq)
    );
  }
  isItemOwned(item) {
    return (
      this.bank.hasItem(item) ||
      (item instanceof EquipmentItem &&
        this.combat.player.checkEquipmentSetsForItem(item))
    );
  }
  ...
  getPageForActiveAction() {
    ...
    } else if (this.farming.isAnyPlotGrown) {
  ...
  constructEventMatcher(data) {
    switch (data.type) {
      case "WoodcuttingAction":
        return new WoodcuttingActionEventMatcher(data, this);
      case "FishingAction":
        return new FishingActionEventMatcher(data, this);
      case "FiremakingAction":
        return new FiremakingActionEventMatcher(data, this);
      case "BonfireLit":
        return new BonfireLitEventMatcher(data, this);
      case "CookingAction":
        return new CookingActionEventMatcher(data, this);
      case "MiningAction":
        return new MiningActionEventMatcher(data, this);
      case "SmithingAction":
        return new SmithingActionEventMatcher(data, this);
      case "ThievingAction":
        return new ThievingActionEventMatcher(data, this);
      case "FarmingPlantAction":
        return new FarmingPlantActionEventMatcher(data, this);
      case "FarmingHarvestAction":
        return new FarmingHarvestActionEventMatcher(data, this);
      case "FletchingAction":
        return new FletchingActionEventMatcher(data, this);
      case "CraftingAction":
        return new CraftingActionEventMatcher(data, this);
      case "RunecraftingAction":
        return new RunecraftingActionEventMatcher(data, this);
      case "HerbloreAction":
        return new HerbloreActionEventMatcher(data, this);
      case "AgilityAction":
        return new AgilityActionEventMatcher(data, this);
      case "SummoningAction":
        return new SummoningActionEventMatcher(data, this);
      case "AstrologyAction":
        return new AstrologyActionEventMatcher(data, this);
      case "AltMagicAction":
        return new AltMagicActionEventMatcher(data, this);
      case "MonsterDrop":
        return new MonsterDropEventMatcher(data);
      case "PlayerAttack":
        return new PlayerAttackEventMatcher(data);
      case "EnemyAttack":
        return new EnemyAttackEventMatcher(data);
      case "FoodEaten":
        return new FoodEatenEventMatcher(data);
      case "PrayerPointConsumption":
        return new PrayerPointConsumptionEventMatcher(data);
      case "PlayerHitpointRegeneration":
        return new PlayerHitpointRegenerationMatcher(data);
      case "PlayerSummonAttack":
        return new PlayerSummonAttackEventMatcher(data);
      case "RuneConsumption":
        return new RuneConsumptionEventMatcher(data);
      case "PotionUsed":
        return new PotionUsedEventMatcher(data);
      case "PotionChargeUsed":
        return new PotionChargeUsedEventMatcher(data);
      case "MonsterKilled":
        return new MonsterKilledEventMatcher(data, this);
      case "ItemEquipped":
        return new ItemEquippedEventMatcher(data, this);
      case "FoodEquipped":
        return new FoodEquippedEventMatcher(data, this);
      case "ShopPurchaseMade":
        return new ShopPurchaseMadeEventMatcher(data, this);
      case "SummonTabletUsed":
        return new SummonTabletUsedEventMatcher(data, this);
    }
  }
  processEvent(event, interval = 0) {
    this.combat.player.consumeEquipmentCharges(event, interval);
    this.potions.consumeCharges(event);
    this.tutorial.updateTaskProgress(event);
  }
  checkSteamAchievements() {
    if (!connectedToSteam) return;
    let achievementIDs = [];
    try {
      achievementIDs = parent.greenworks.getAchievementNames();
    ...
    achievementIDs.forEach((achieveID, i) => {
      ...
      if (achievement === undefined) {
        console.warn(
          `Error checking steam achievements, no data exists for achievement with id: ${achieveID}`
        );
        return;
      }
    ...
    parent.greenworks.setRichPresence(
      "currentGamemode",
      this.currentGamemode.name
    );
    parent.greenworks.setRichPresence(
      "skillLevel",
      "" + this.completion.skillProgress.currentCount.getSum() + ""
    );
    parent.greenworks.setRichPresence(
      "steam_display",
  ...
  isAchievementMet(achievement) {
    if (
      achievement.requiredGamemode !== undefined &&
      this.currentGamemode !== achievement.requiredGamemode
    )
      return false;
    ...
    switch (achievement.id) {
      ...
      case "NEW_ACHIEVEMENT_3_20":
        return (
          this.completion.itemProgress.getPercent("melvorBaseGame") === 100
        );
      ...
      case "NEW_ACHIEVEMENT_3_22":
        return (
          this.completion.masteryProgress.getPercent("melvorBaseGame") === 100
        );
      case "NEW_ACHIEVEMENT_1_29":
      case "NEW_ACHIEVEMENT_3_23":
        return (
          this.completion.monsterProgress.getPercent("melvorBaseGame") === 100
        );
      ...
      case "NEW_ACHIEVEMENT_2_27": {
        ...
        return (
          plant !== undefined &&
          this.stats.Monsters.get(plant, MonsterStats.KilledPlayer) > 0
        );
      }
      default:
        return false;
  ...
  setupCurrentGamemode() {
    ...
    this.currentGamemode.startingItems.forEach(({ item, quantity }) =>
      this.bank.addItem(item, quantity, false, true)
    );
    this.settings.changeChoiceSetting(
      "defaultPageOnLoad",
      this.currentGamemode.startingPage
    );
  }
  ...
  convertFromOldFormat(save, idMap) {
    if (save.serialData !== undefined) {
      if (save.version <= 3) {
        ...
        if (save.offline.skill !== null && save.offline.skill === 9)
          this.activeAction = this.combat;
    ...
    if (save.currentGamemode !== undefined) {
      ...
      if (gamemode === undefined)
        throw new Error(
          `Error converting save. Gamemode with id: ${gamemodeID} is not registered.`
        );
      this.currentGamemode = gamemode;
    }
    ...
    if (save.MASTERY !== undefined) {
      Object.entries(save.MASTERY).forEach(([oldSkillID, oldMasteryData]) => {
        const skill = this.masterySkills.getObjectByID(
          idMap.skills[parseInt(oldSkillID)]
        );
        if (skill === undefined) return;
