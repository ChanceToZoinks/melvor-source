...
declare function getExclusiveRandomArrayElements(array: any, numElements: any): Set<any>;
...
declare function imageNotify(media: any, message: any, messageTheme?: string): void;
...
declare function notifyPlayer(skill: any, message: any, messageTheme?: string): void;
...
declare function templateLangString(category: any, identifier: any, templateData: any): any;
...
declare function templateLangStringWithNodes(category: any, id: any, nodeData: any, textData: any, clone?: boolean): any[];
declare function templateStringWithNodes(string: any, nodeData: any, textData: any, clone?: boolean): any[];
...
declare function getElementFromFragment(fragment: any, elementID: any, tagName: any): any;
declare function formatFixed(num: any, digits: any): any;
declare function switchToCategory(tabs: any): (categoryToShow: any) => void;
declare function downloadTextFile(fileName: any, fileText: any, fileType?: string): void;
...
declare function generateComponentClass(templateID: any, tagName: any, className: any): string;
...
declare function levelUnlockSum(skill: any): (previous: any, current: any) => any;
...
declare class UnregisteredApplyDataModError extends Error {
    constructor(objectBeingModded: any, unregisteredName: any, unregisteredID: any);
}
