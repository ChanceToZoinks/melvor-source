...
declare class Township extends Skill {
    ...
    getSingleResourceGainAmountInBiome(resource: any, building: any, biome: any): number;
    ...
    addPopulation(): void;
    getTrueMaxProductCreationAmount(resource: any, withoutModifiers?: boolean): number;
    getMaxProductCreationAmount(resource: any, withoutModifiers?: boolean): number;
    ...
    getMaxPossibleConvertFromTownshipValue(resource: any, convertRatio: any): number;
}
