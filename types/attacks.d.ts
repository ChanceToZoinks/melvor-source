declare function damageReducer(attacker: any, target: any, prevDamage?: number): (totalDamage: any, damage: any) => any;
declare function getMaxDamage(damage: any, attacker: any, target: any, prevDamage?: number): number;
declare function getDamageRoll(character: any, type: any, percent: any, damageDealt?: number): number;
declare function getDamageDescription(damage: any, attackerName: any, targetName: any, i: any, key: any): string;
declare function getEffectDescription(effect: any, attackerNoun: any, targetNoun: any, key: any): string;
...
declare function addEffectTemplateData(data: any, effect: any, preHit: any, i: any): void;
...
declare const elementalEffects: (BurnEffect | {
    type: string;
    modifiers: {
...
declare namespace attackDescriptors {
    ...
    function CanMiss(attack: any, attNoun: any, targNoun: any): "can't miss" | "can miss";
    function Avoidable(attack: any, attNoun: any, targNoun: any): "unavoidable" | "avoidable";
...
declare function generateAttackDescription(attack: any, attNoun: any, targNoun: any): any;
