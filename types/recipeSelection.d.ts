declare class RecipeSelectionTab extends ContainedComponent {
    constructor(parentID: any, skill: any, recipes: any, containerID: any, recipeCollapse?: string);
    skill: any;
    recipes: any;
...
declare class CategoryMenu extends ContainedComponent {
    constructor(parentID: any, navID: any, categoryData: any, expandTextID: any, changeCategoryFunc: any);
    navID: any;
    categoryData: any;
    expandTextID: any;
    optionNames: any[];
