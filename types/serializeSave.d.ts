...
declare function getStatDeserializer(
  statVar: any
): (sData: any, sVersion: any) => any;
...
declare function deserializeEquipment(
  sData: any,
  sVersion: any
): {
  equipment: any[];
...
declare function deserializeMonsterStats(
  sData: any,
  sVersion: any
): {
  monsterID: number;
...
declare function deserializeItemStats(
  sData: any,
  sVersion: any,
  idMap: any
): any;
declare function deserializeSettings(
  sData: any,
  sVersion: any
):
  | {
...
declare function deserializeSettingsOld(
  sData: any,
  sVersion: any
): {
  bank: {
...
declare function deserializeDefaultItemTabs(
  sData: any,
  sVersion: any
): {
  itemID: any;
...
declare function deserializeBank(
  sData: any,
  sVersion: any
): {
  id: any;
...
declare function deserializeGlovesTracker(
  sData: any,
  sVersion: any
): {
  isActive: boolean;
...
declare function deserializeRockData(
  sData: any,
  sVersion: any
): {
  maxHP: any;
...
declare function deserializeSlayerTask(
  sData: any,
  sVersion: any
): {
  monsterID: any;
...
declare function deserializeCombatData(
  sData: any,
  sVersion: any
): {
  player: {
...
declare function deserializeFood(
  sData: any,
  sVersion: any
): {
  itemID: any;
