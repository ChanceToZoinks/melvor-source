...
declare function printPlayerModifier(key: any, value: any, precision: any): any[];
declare function isSkillEntry(entry: any): any;
declare function isSkillKey(key: any): any;
declare function addModifierTemplateData(formatData: any, modifiers: any, key: any): void;
...
declare function getModifierDataSpans(modifiers: any, negMult?: number, posMult?: number): any[];
declare function getSpansFromModifierObject(modifiers: any, negMult?: number, posMult?: number): any[];
...
declare class MappedModifiers {
    ...
    addSkillModifiers(key: any, values: any, negMult?: number, posMult?: number): void;
    ...
    getModifierDescriptionsAsNodes(tagName: any, additionalClasses?: any[]): any[];
}
