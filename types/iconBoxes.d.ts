declare class IconBox extends ContainedComponent {
    constructor(parent: any, smallName: any, containerClasses?: any[], iconContClasses?: any[]);
    icons: any[];
    container: any;
    name: any;
    iconContainer: any;
...
declare class RequiresBox extends IconBox {
    constructor(parent: any, smallName: any, containerClasses?: any[], iconContClasses?: any[], size?: number, titleLangID?: string);
    size: number;
    titleLangID: string;
...
declare class GrantsBox extends IconBox {
    constructor(parent: any, smallName: any, containerClasses?: any[], size?: number, iconContClasses?: any[]);
    xpIcon: XPIcon;
